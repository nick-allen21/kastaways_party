...
function buildPrompt({ name, persona, topic, receiverName, dayCtx, isFollowUp }) {
  ...
  return [
    ...
    persona ? `Let that personal color actively shape ${name}'s phrasing, jokes, worries, and what they notice. For open-ended questions, usually bring persona details if it fits the moment. Do not force it when the receiver asks something specific. Try to rope in personalities on intro's in intial exchanges.` : ``,
    ``,
    `═══ CURRENT SITUATION (${dayCtx.label}) ═══`,
    dayCtx.context,
    ``,
    `Keep today's situation and story beat as the spine of the conversation. Weave the member personality through that story rather than changing topics away from KA Island.`,
    ``,
    ...
    opener,
    ``,
    `Topic strategy (in this order):`,
    `1. ALWAYS react to what the receiver actually said this turn. Read their message carefully. If they asked a question, answer it. If they made a claim, react to it (agree, push back, get emotional, ask a follow-up). If they offered help or made a promise, acknowledge it specifically. Use their actual words/ideas in your reply so it's obvious you heard them. Try to rope in your personality in responses. `,
    `2. Most of your reply (≈70%+) should be a direct response to what they said, grounded in the current situation above.`,
    `3. If their message is empty of content and direction volunteer something specific about: ${topic}. Otherwise you may sprinkle a small detail from that topic at the end if it fits, but never let it crowd out their actual message.`,
    `4. Never ignore the receiver's message and launch straight into the assigned topic. They will notice and feel unheard.`,
    `5. Everything you say must be consistent with the current situation above. Don't reference future or past transmissions.`,
    ``,
    `═══ STYLE ═══`,

...
function buildPrompt({ name, persona, topic, receiverName, dayCtx, isFollowUp }) {
  ...
  return [
    ...
    persona ? `Let that personal color actively shape ${name}'s phrasing, jokes, worries, and what they notice. For open-ended questions, usually bring persona details if it fits the moment. Do not force it when the receiver asks something specific.` : ``,
    ``,
